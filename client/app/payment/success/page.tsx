      ...
      <div className="max-w-2xl w-full space-y-6">
        ...
        <Card className="border-2 border-green-200 dark:border-green-800 shadow-xl">
          <CardHeader className="text-center space-y-2">
            <CardTitle className="text-3xl font-bold text-green-600 dark:text-green-400 flex items-center justify-center gap-2">
          ...
          <CardContent className="space-y-6">
            {/* Transaction Details */}
            <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950 dark:to-gray-900 rounded-lg p-6 space-y-4">
              ...
              <div className="grid gap-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 font-semibold">
