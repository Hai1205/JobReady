...
import { RevenueStats } from "@/components/commons/admin/dashboard/RevenueStats";
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <StatsCard
          ...
          subtitle={`${dashboardStats.usersCreatedThisMonth} this month`}
        ...
        <StatsCard
          ...
          subtitle={`${dashboardStats.pendingUsers} pending, ${dashboardStats.bannedUsers} banned`}
          icon={<Users className="h-4 w-4" />}
        ...
        <StatsCard
          title="Total CVs"
          value={dashboardStats.totalCVs}
          subtitle={`${dashboardStats.cvsCreatedThisMonth} this month`}
        ...
        <StatsCard
          title="Public CVs"
          value={dashboardStats.publicCVs}
          subtitle={`${dashboardStats.privateCVs} private`}
      ...
      {/* Revenue Stats */}
      <RevenueStats revenueStats={dashboardStats.revenueStats} />
