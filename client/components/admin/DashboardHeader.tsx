    ...
    <div className="flex items-center justify-between pb-6 border-b border-border/50 mb-6">
      ...
      <div className="flex items-center gap-3">
        ...
        {onCreateClick && (
          <Button
            size="sm"
            className="h-9 gap-2 px-4 bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 shadow-lg shadow-primary/30 transition-all duration-200 hover:shadow-xl hover:shadow-primary/40 hover:scale-105"
