...
public interface UserCommandRepository extends JpaRepository<User, UUID> {
        ...
        @Modifying
        @Transactional
        @Query("UPDATE User u SET u.planType = :planType, u.planExpiration = :planExpiration, u.updatedAt = :updatedAt WHERE u.id = :userId")
        int updateUserPlan(@Param("userId") UUID userId,
                        @Param("planType") User.PlanType planType,
                        @Param("planExpiration") LocalDateTime planExpiration,
                        @Param("updatedAt") LocalDateTime updatedAt);

        @Modifying
        @Transactional
        @Query("UPDATE User u SET u.planType = :planType, u.planExpiration = :planExpiration, u.updatedAt = :updatedAt WHERE u.email = :email")
        int updateUserPlanByEmail(@Param("email") String email,
                        @Param("planType") User.PlanType planType,
                        @Param("planExpiration") LocalDateTime planExpiration,
                        @Param("updatedAt") LocalDateTime updatedAt);
}
